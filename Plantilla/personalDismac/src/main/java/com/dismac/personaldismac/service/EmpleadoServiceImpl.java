...
import com.dismac.personaldismac.feingClient.HistorialLaboralFeignClient;
...
public class EmpleadoServiceImpl  implements  EmpleadoService {
    ...
    @Autowired
    private HistorialLaboralFeignClient historialLaboralFeignClient;
    ...
    public EmpleadoDTO registrarEmpleado(EmpleadoCreateDTO empleadoCreateDTO) {
        ...
        //Registrar el historial Laboral
        List<HistorialLaboralDTO> listaHistorial = empleadoCreateDTO.getHistorialLaboral();
        for ( HistorialLaboralDTO itemHistorial: listaHistorial) {
            itemHistorial.setIdEmpleado( respuestaEntity.getId() );
            historialLaboralFeignClient.registrarHistorialLaboral(itemHistorial);
        }
